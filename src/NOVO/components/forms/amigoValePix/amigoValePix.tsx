...
export const NewAmigoValePixForm = ({ partner }: props) => {
      ...
      >
        ...
        <div className="flex flex-wrap -mx-3 mb-6">
          ...
          <div className="w-full md:w-1/2 px-3 mb-8 md:mb-0">
            ...
            id="grid-first-name ${
              ra.length ? "border-gray-200" : "border-red-500"
            }`}
              type="text"
              placeholder="R.A"
            ...
            />
            <p
              className="text-red-500 text-xs italic mb-5"
              style={ra.length ? { display: "none" } : {}}
            >
