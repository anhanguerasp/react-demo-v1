      ...
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        ...
        <div className="flex justify-center ">
          ...
          <a
            ...
            className="text-neutral-600 dark:text-neutral-200 hover:text-orange-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <div className="">
            ...
            <p className="mb-4">
              <Link
                ...
                className="text-neutral-600 dark:text-neutral-200 excluir-alerta hover:text-orange-500 dark:hover:text-orange-500"
              >
                Graduação
              </Link>
            </p>
