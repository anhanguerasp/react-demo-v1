...
import Transition from "../../../utils/consultoresLayout/Transition";

function Features() {
  const [tab, setTab] = useState(1);

  const tabs = useRef({} as any);
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            >
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                <h4 className="h3 mb-3 text-4xl font-bold">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      De inicio aos trabalhos de forma imediata e sem a
                      necessidade de possuir experiência profissional prévia.
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">
                      Realize suas vendas de qualquer localidade, sem a
                      necessidade de locomoção ou de encontros presenciais.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">
                      Faça o seu própio horário
                    </div>
                    <div className="text-gray-600">
                      Aqui você faz o seu horário de trabalho, de maneira 100%
                      flexivel.
                    </div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
