...
export const Index = () => {
  return (
    <main className="politica-termos">
      <h1>Política de Privacidade</h1>
      <h2>Central de ensinos LTDA</h2>
      <p>
        A Central de ensinos LTDA, pessoa jurídica de direito privado, com sede
        na Rua Barão de Itapetininga, 298 - República, SP, inscrita no CNPJ/MF
        sob o nº 46.550.820/0001-58 leva a sua privacidade a sério e zela pela
        segurança e proteção de dados de todos os seus clientes, parceiros,
        fornecedores e usuários do site “anhanguerasp.com.br” e qualquer outro
        site, Loja, aplicativo operado pelo Grupo Anhanguera SP.{" "}
      </p>
      <p>
        ...
        nosso site e em mensagens que trocamos com você.
      </p>
      <p>
        AO ACESSAR A SITE, ENVIAR COMUNICAÇÕES OU FORNECER QUALQUER TIPO DE DADO
        PESSOAL, VOCÊ DECLARA ESTAR CIENTE E DE ACORDO COM ESTA POLÍTICA DE
        PRIVACIDADE, A QUAL DESCREVE AS FINALIDADES E FORMAS DE TRATAMENTO DE
        SEUS DADOS PESSOAIS QUE VOCÊ DISPONIBILIZAR NA SITE.
      </p>
      <p>
        ...
        com contato@anhanguerasp.com.br.
      </p>
      <p>
        ...
        terceiros que possam ser oferecidos ou acessados por meio do site. O
        acesso a esses links fará com que você deixe a Loja e possa resultar na
        coleta ou compartilhamento de informações sobre você por terceiros. Nós
        não controlamos, endossamos ou fazemos quaisquer representações sobre
        esses sites de terceiros ou suas práticas de privacidade, que podem ser
        diferentes das nossas. Recomendamos que você revise a política de
        privacidade de qualquer site com o qual você interaja antes de permitir
        a coleta e o uso de seus Dados Pessoais.
      </p>
      <p>
      ...
      <li className="li-2">
        ...
        indiretamente, identifique ou possa identificar uma pessoa natural, como
      ...
      <li className="li-2">
        ...
        harmonização ou associação, restrição, eliminação ou destruição. Também
        é considerado Tratamento de Dados Pessoais qualquer outra operação
        prevista nos termos da legislação aplicável;
      </li>
      <li className="li-2">
        “Leis de Proteção de Dados” significa todas as disposições legais que
        regulem o Tratamento de Dados Pessoais, incluindo, porém sem se limitar,
        a Lei nº 13.709/18, Lei Geral de Proteção de Dados Pessoais (“LGPD”).
      </li>
      ...
      <ul>
        <li>
          ...
          <p>
            ...
            e/ou serviços no site, personalizando e melhorando sua experiência.
        ...
        <li className="li-2">
          ...
          interesse em nossos serviços; e
        </li>
        <li className="li-2">
          Podemos entrar em contato com você pessoalmente, por mensagem de voz,
          através de equipamentos de discagem automática, por mensagens de texto
        ...
        <p>
          ...
          de residência; (d) para proteger nossas operações; (e) para proteger
          direitos, privacidade, segurança nossos, seus ou de terceiros; (f)
          para detectar e prevenir fraude; (g) permitir-nos usar as ações
          disponíveis ou limitar danos que venhamos a sofrer; (h) de outros
          modos permitidos por lei.
        </p>
        <p>
          A NOSSO SITE NÃO SE DESTINA A PESSOAS COM MENOS DE 18 (DEZOITO) ANOS E
          PEDIMOS QUE TAIS PESSOAS NÃO NOS FORNEÇAM QUALQUER DADO PESSOAL
        </p>

        <li>
          <h3>Não fornecimento de Dados Pessoais</h3>
          <p>
            Você não é obrigado a compartilhar os Dados Pessoais que
            solicitamos, no entanto, se você optar por não os compartilhar, em
            alguns casos, não poderemos fornecer a você acesso completo ao site,
        ...
        <li>
          ...
          <p>
            ...
            funcionalidades do site poderão depender de cadastro e envio de
        ...
        <li>
          <h3>No contato ao site, nós podemos coletar:</h3>
        </li>
        <li className="li-2">
        ...
        <li>
          <h3>Na navegação geral no site, nós poderemos coletar:</h3>
        </li>
        <li className="li-2">
          Dados de localização. Dados de geolocalização quando você acessa o
          site;
        </li>
        <li className="li-2">
        ...
        <li className="li-2">
          Dados de navegação no site. Informações sobre suas visitas e
          atividades no site, incluindo o conteúdo (e quaisquer anúncios) com os
          ...
          Coleta Automática de Dados no item 7 abaixo;
        </li>
        <li className="li-2">
          Dados anônimos ou agregados. Respostas anônimas para pesquisas ou
          informações anônimas e agregadas sobre como o site é usufruída.
          ...
          desses dados com a tecnologia disponível; e
        </li>
        <li className="li-2">
          ...
          dispositivo; dados de uso do site; e informações coletadas por meio de
          cookies, pixel tags e outras tecnologias.
        </li>
        <p>
          Ao menos que você informe em algum formulário livre preenchido por
          você, nós não coletamos Dados Pessoais Sensíveis.
        </p>
        ...
        <li>
          <h3>Forma de coleta automática de Dados Pessoais</h3>
          <p>
            Quando você visita o site, ela pode armazenar ou recuperar
            informações em seu navegador, seja na forma de cookies e de outras
            tecnologias semelhantes. Essas informações podem ser sobre você,
            suas preferências ou seu dispositivo e são usadas principalmente
            para que o site funcione como você espera. As informações geralmente
        ...
        <li className="li-2">
          ...
          o tipo de navegador, o tempo dispendido no site, as páginas visitadas,
          ...
          do site para aprimoramento contínuo do nosso design e funcionalidade.
        </li>
        <li className="li-2">
          ...
          de internet mais populares:
        </li>
        <li className="li-3">Google Chrome</li>
        <li className="li-3">Mozilla Firefox</li>
        <li className="li-3">Safari</li>
        <li className="li-3">Internet Explorer</li>
        <li className="li-3">Microsoft Edge</li>
        <li className="li-3">Opera</li>
        <li className="li-2">
          o Caso deseje saber um pouco mais sobre os cookies de publicidade e
          marketing, que servem para direcionarmos publicidade em função dos
          interesses de cada usuário e do número de visitas que realizou em
          nosso site e suas buscas na internet, acesse:
        </li>
        <li className="li-3">Facebook</li>
        <li className="li-3">Google</li>
        <li className="li-3">Bing</li>
        <p>
          ...
          para rastrear ações de usuários do site (incluindo destinatários de
          e-mails), medir o sucesso das nossas campanhas de marketing e coletar
          dados estatísticos sobre o uso do site e taxas de resposta. Em caso de
          ...
          seus serviços.No caso de você não desejar ser rastreado pode pedir
          para cada um dos serviços:
        </p>
        <li className="li-2">Facebook</li>
        <li className="li-2">Google</li>
        <li className="li-2">Bing</li>
        <p>
          Podemos contratar empresas de publicidade comportamental, para obter
          relatórios sobre os anúncios do site em toda a internet. Para isso,
          ...
          outros usuários, da nosso site e de site de terceiros. Nós não somos
        ...
        <li>
          ...
          <p>
            ...
            para qualquer um desses sites, lembramos que cada site possui as
        ...
        <li>
          ...
          <p>
            ...
            texto no site, com a data de revisão atualizada. Podemos alterar
            esta Política de Privacidade a qualquer momento. Caso haja alteração
            significativa nos termos dessa Política de Privacidade, podemos
            informá-lo por meio das informações de contato que tivermos em nosso
            banco de dados ou por meio de notificação em nosso site.
          </p>
          <p>
          ...
          <p>
            Sua utilização do site após as alterações significa que aceitou as
        ...
        <li>
          <h3>Pessoa responsável do tratamento dos Dados Pessoais</h3>
          <p>
            ...
            Pessoais, favor contatar-nos através do e-mail
