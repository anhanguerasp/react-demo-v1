...
export const Index = () => {
  return (
    <main className="politica-termos">
      ...
      <p>
        Central de Ensinos LTDA, pessoa jurídica de direito privado descreve,
        através deste documento, as regras de uso do site
        https://anhanguerasp.com.br e qualquer outro site, loja ou aplicativo
      ...
      <p>
        Caso você não esteja de acordo com as condições deste contrato, pedimos
        que não faça mais uso deste website, muito menos cadastre-se ou envie os
        seus dados pessoais.
      </p>
      <p>
      ...
      <p>
        A utilização deste website após as alterações significa que você aceitou
        os Termos de Uso revisados. Caso, após a leitura da versão revisada,
        você não esteja de acordo com seus termos, favor encerrar o seu acesso.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            Uso e a versão mais atualizada da Política de Privacidade de Central
            de Ensinos LTDA.
          </p>
        </li>
        <li>
          ...
          <p>
            Em geral, o acesso ao website da Central de Ensinos LTDA possui
          ...
          <p>
            ...
            comentários em determinadas áreas. Central de Ensinos LTDA não
            consente com a publicação de conteúdos que tenham natureza
            discriminatória, ofensiva ou ilícita, ou ainda infrinjam direitos de
            autor ou quaisquer outros direitos de terceiros.
          </p>
          <p>
            ...
            publicação pela Central de Ensinos LTDA no seu website, plataformas
            e aplicações de internet, ou ainda em outras plataformas, sem
            qualquer restrição ou limitação.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            Todos os elementos de Central de Ensinos LTDA são de propriedade
            intelectual da mesma ou de seus licenciados. Estes Termos ou a
            utilização do website não concede a você qualquer licença ou direito
            de uso dos direitos de propriedade intelectual da Central de Ensinos
            LTDA ou de terceiros.
          </p>
        </li>
        <li>
        ...
        <li>
          <h3>Seção 7 - Parazos e Alterações</h3>
          <p>O funcionamento deste website se dá por prazo indeterminado.</p>
          <p>
            O website no todo ou em cada uma das suas seções, pode ser
            encerrado, suspenso ou interrompido unilateralmente por Central de
            Ensinos LTDA, a qualquer momento e sem necessidade de prévio aviso.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            coletados e tratados por Central de Ensinos LTDA e/ou pelos
            Parceiros. As regras relacionadas ao tratamento de dados pessoais de
            Central de Ensinos LTDA estão estipuladas na Política de
            Privacidade.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            entre em contato pelo e-mail contato@anhanguerasp.com.br.
          </p>
        </li>
      </ul>
    </main>
