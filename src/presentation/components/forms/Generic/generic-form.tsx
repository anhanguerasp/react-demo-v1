...
import { IMatricula } from "../../../../domain/models/IMatricula";
import { SwitchFormulary } from "../switchFormulary/SwitchFormulary";
...
export const GenericForm = ({ partner }: props) => {
  ...
  return (
    <form
      method="post"
      className="w-full w-full md:w-1/2 bg-white p-12 dark:bg-black rounded-r-lg"
